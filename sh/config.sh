...
export PERL_PACKAGES="File::Slurp Moose JSON Method::Signatures::Simple Exporter::Easy DBI Bytes::Random::Secure Digest::SHA1 Crypt::Eksblowfish::Bcrypt Crypt::CBC indirect Readonly Clone Math::Random::MT Data::Password::Common Statistics::Descriptive CGI::PSGI Text::Diff Task::Plack DBD::Pg Crypt::Blowfish Text::Template Term::ReadLine"
